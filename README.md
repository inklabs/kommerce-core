...
This project is over 52,000 lines of code. Unit tests account for 30-40% of that total and execute in
...
* <a name="domain-event"></a>Domain Event
    ...
    - Events can be dispatched directly in the service layer. This is usually done for Entity creation
      when you do not yet have access to the id generated by the repository. (deprecated)
